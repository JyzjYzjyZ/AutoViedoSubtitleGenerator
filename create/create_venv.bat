...
echo Your ASR virtual environment has been successfully created,next will be install PyQt5
pause
pip install PyQt5  -i https://pypi.tuna.tsinghua.edu.cn/simple
pip list
echo Your all virtual environment has been successfully created
pause