...
'''
Gui_Element_dataFrame import Element_data是最基本的
这里执行了生成menu的操作，得到了parentWidget等

若使handleclick访问到，先生成ui.在最后绑定方法
 Gui_body中绑定了方法，而此文件引用
 故需要调整顺序
'''
...
class MainWindow(QWidget):
    ...
    def createElement(self,path):
        ...
        return element_data# element_data.WidgetObj为主元素
