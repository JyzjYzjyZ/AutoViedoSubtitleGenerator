...
path_model_Vosk = r'.\models\vosk-model-en-us-0.22'
path_model_Sphinx = r'.\models\sphinx'
path_model_huggingface_big = r'.\models\facebookhubert-xlarge-ls960-ft'
path_model_huggingface_small = r'.\models\facebookwav2vec2-large-960h'
path_model_SpeechSplit = r'.\models\pyannote-segmentation\pytorch_model.bin'
...
#-----------------------------------------------------------------------------------------------------------------------
# def Mix_timeLineToSentences(t,s):
# #这个类里好像有
#     if len(t) != len(s):
